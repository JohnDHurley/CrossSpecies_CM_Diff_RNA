---
title: "RNA_CorMotif_Comp_Trajectory_Symbol"
...
```{r Setting_Up_Enviroment, message=FALSE, warning=FALSE}
...
Filt_RMG0_RNA_fc_NoD4 <- readRDS("data/QC/Symbol/Filt_RMGO_RNA_fc_NoD4_unique.RDS")

# Filt_RMG0_RNA_log2cpm_NoD4_NoRep <- readRDS("data/Cormotif/SymbolFilt_RMG0_RNA_log2cpm_NoD4_NoRep.RDS")

```

```{r Cormotif Function, warning=FALSE, message=FALSE, results="hide"}
...
```{r}
Filt_RMG0_RNA_fc_NoD4 <- readRDS("data/QC/Symbol/Filt_RMGO_RNA_fc_NoD4_unique.RDS")
Filt_RMG0_RNA_fc_NoD4_NoRep <-
  Filt_RMG0_RNA_fc_NoD4 %>%
  dplyr::select(-contains("R"))

Filt_RMG0_RNA_log2cpm_NoD4_NoRep <- cpm(Filt_RMG0_RNA_fc_NoD4_NoRep, log = TRUE)
Filt_RMG0_RNA_log2cpm_NoD4_NoRep <- as.matrix(Filt_RMG0_RNA_log2cpm_NoD4_NoRep)



# saveRDS(Filt_RMG0_RNA_fc_NoD4_NoRep,"data/Cormotif/Symbol/Filt_RMG0_RNA_fc_NoD4_NoRep.RDS")
# saveRDS(Filt_RMG0_RNA_log2cpm_NoD4_NoRep,"data/Cormotif/Symbol/Filt_RMG0_RNA_log2cpm_NoD4_NoRep.RDS")
```
...
saveRDS(motif.fitted,"data/Cormotif/Symbol/cormotif_RNA__seed8_k8_DayBefore_emmaCode.RDS")
...
saveRDS(motif_prob,"data/Cormotif/Symbol/RNA_motif_prob_Trajectory.RDS")
...
saveRDS(clust1_RNA,"data/Cormotif/Symbol/clust1_RNA_Symbol.RDS")
saveRDS(clust2_RNA,"data/Cormotif/Symbol/clust2_RNA_Symbol.RDS")
saveRDS(clust3_RNA,"data/Cormotif/Symbol/clust3_RNA_Symbol.RDS")
saveRDS(clust4_RNA,"data/Cormotif/Symbol/clust4_RNA_Symbol.RDS")
saveRDS(clust5_RNA,"data/Cormotif/Symbol/clust5_RNA_Symbol.RDS")
saveRDS(clust6_RNA,"data/Cormotif/Symbol/clust6_RNA_Symbol.RDS")
saveRDS(clust7_RNA,"data/Cormotif/Symbol/clust7_RNA_Symbol.RDS")
saveRDS(clust8_RNA,"data/Cormotif/Symbol/clust8_RNA_Symbol.RDS")
saveRDS(clust9_RNA,"data/Cormotif/Symbol/clust9_RNA_Symbol.RDS")
saveRDS(clust10_RNA,"data/Cormotif/Symbol/clust10_RNA_Symbol.RDS")
saveRDS(clust11_RNA,"data/Cormotif/Symbol/clust11_RNA_Symbol.RDS")
```
