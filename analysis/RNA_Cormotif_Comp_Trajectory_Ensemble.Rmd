...
#Loading R Object from this workbook
...
# motif_prob <- readRDS("data/RNA_motif_prob_Trajectory.RDS")
...
saveRDS(motif.fitted,"data/Cormotif/concat/cormotif_RNA__seed8_k1_15_DayBefore_emmaCode.RDS")
motif.fitted <- readRDS("data/Cormotif/concat/cormotif_RNA__seed8_k1_15_DayBefore_emmaCode.RDS")
plotIC(motif.fitted)
motif.fitted$bic
