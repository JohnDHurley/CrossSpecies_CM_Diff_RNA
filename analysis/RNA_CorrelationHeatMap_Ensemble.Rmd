...
library(ggplot2)
expressed_genes <- TopTable_RNA_All$Gene
...
```{r RNASeq_MarkerGenes_graph_species_Heatmap_graph_OrthoGenes, fig.height=10,fig.width=10}
pheatmap(
  mat,
...
```{r RNASeq_MarkerGenes_graph_species_Heatmap_graph_OrthoExpressed, fig.height=10,fig.width=10}
pheatmap(
  mat_expressed,
