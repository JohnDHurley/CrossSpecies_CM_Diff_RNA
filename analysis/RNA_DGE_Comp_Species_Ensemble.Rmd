...
```{r RNASeq_DGE_TopTable_Subsetting}
TopTable_RNA_All <- readRDS("data/TopTable_RNA_all.RDS")
...
TopTable_RNA_All <- readRDS("data/TopTable_RNA_all.RDS")
clust1_RNA <- readRDS("data/Cormotif/Species/clust1_RNA.RDS")
clust2_RNA <- readRDS("data/Cormotif/Species/clust2_RNA.RDS")
clust3_RNA <- readRDS("data/Cormotif/Species/clust3_RNA.RDS")
clust4_RNA <- readRDS("data/Cormotif/Species/clust4_RNA.RDS")
clust5_RNA <- readRDS("data/Cormotif/Species/clust5_RNA.RDS")
clust6_RNA <- readRDS("data/Cormotif/Species/clust6_RNA.RDS")
clust7_RNA <- readRDS("data/Cormotif/Species/clust7_RNA.RDS")
clust8_RNA <- readRDS("data/Cormotif/Species/clust8_RNA.RDS")
clust9_RNA <- readRDS("data/Cormotif/Species/clust9_RNA.RDS")
clust10_RNA <- readRDS("data/Cormotif/Species/clust10_RNA.RDS")
clust11_RNA <- readRDS("data/Cormotif/Species/clust11_RNA.RDS")
