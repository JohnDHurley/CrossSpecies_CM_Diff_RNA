...
# saveRDS(Day0_DEGs_HC,"data/DGE/Species/Day0_DEGs_HC_0.1.RDS")
# saveRDS(Day2_DEGs_HC,"data/DGE/Species/Day2_DEGs_HC_0.1.RDS")
# saveRDS(Day5_DEGs_HC,"data/DGE/Species/Day5_DEGs_HC_0.1.RDS")
# saveRDS(Day15_DEGs_HC,"data/DGE/Species/Day15_DEGs HC_0.1HC.RDS")
# saveRDS(Day30_DEGs_HC,"data/DGE/Species/Day30_DEGs_HC_0.1HC.RDS")
# saveRDS(all_genes,"data/DGE/Species/ExpressedGenes.RDS")
# saveRDS(deg_genes,"data/DGE/Species/DEG_AtLeastOne_0.1.RDS")
...
sets <- list(
  Day0 = Day0_DEGs_HC$Gene,       # TopTable data.frame
  Day2 = Day2_DEGs_HC$Gene,
  Day5 = Day5_DEGs_HC$Gene,
  Day15 = Day15_DEGs_HC$Gene,
  Day30 = Day30_DEGs_HC$Gene
)
```


```{r RNASeq_DGE_Species_TopTable_Venn_ggplot_plot,fig.height=5,fig.width=9}
