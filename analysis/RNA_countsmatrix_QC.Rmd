...
rownames(RNA_flagstat)<-row_names
...
ggplot(RNA_flagstat, aes(x = row_names, y = Total.Reads/2)) +
  geom_col() +
...
ggplot(RNA_flagstat, aes(x="All",y = Total.Reads/2)) +
...
=======
```{r Plotting_Boxplot_rawcounts_byspecies fig.height=8,fig.width=12}
>>>>>>> da5ca35b22febe8b1241973bb9aec1a57eda53dc
library(ggplot2)

ggplot(RNA_flagstat, aes(x = Species, y = Total.Reads/2, fill = Species)) +
  geom_boxplot() +
  geom_jitter(aes(fill = Species),
              position = position_jitterdodge(jitter.width = 0.2,
                                              dodge.width = 0.8),
...
ggplot(RNA_flagstat, aes(x = Timepoint, y = Total.Reads/2, fill = Species)) +
  geom_boxplot() +
 geom_jitter(aes(fill = Species),
              position = position_jitterdodge(jitter.width = 0.2,
                                              dodge.width = 0.8),
...
ggplot(RNA_flagstat, aes(x = Cell.Line, y = Total.Reads/2, fill = Cell.Line)) +
  geom_boxplot() +
 geom_jitter(aes(fill = Cell.Line),
              position = position_jitterdodge(jitter.width = 0.2,
                                              dodge.width = 0.8),
              size = 3,
              alpha = 0.9,
...
ggplot(RNA_flagstat, aes(x = row_names, y = Duplication..*100))+
  geom_col() +
  ylim(0,100)
  theme_bw() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1,vjust=0.4,size=9)) +
...
```
```{r Plotting_Boxplot_Duplication,fig.height=5,fig.width=5}
ggplot(RNA_flagstat, aes(x="All",y = Duplication..*100)) +
  geom_boxplot(fill = "lightblue") +
geom_jitter(aes(fill = Species),
              position = position_jitterdodge(jitter.width = 0.2,
                                              dodge.width = 0.6),
  ...
  theme_bw() +
  labs(
    title = "Duplication Across All Samples",
    y = "Percent Duplicaiton",
    x = ""
  )
```
<<<<<<< HEAD
```{r Plotting_Boxplot_Duplication_byspecies,fig.height=8,fig.width=12}
=======
```{r Plotting_Boxplot_Duplication_byspecies fig.height=8,fig.width=12}
>>>>>>> da5ca35b22febe8b1241973bb9aec1a57eda53dc
library(ggplot2)

ggplot(RNA_flagstat, aes(x = Species, y = Duplication..*100, fill = Species)) +
  geom_boxplot() +
  geom_jitter(aes(fill = Species),
              position = position_jitterdodge(jitter.width = 0.2,
                                              dodge.width = 0.8),
...
```
<<<<<<< HEAD
```{r Plotting_Boxplot_Duplication_bytimepoint,fig.height=8,fig.width=12}
=======
```{r Plotting_Boxplot_Duplication_bytimepoint fig.height=8,fig.width=12}
>>>>>>> da5ca35b22febe8b1241973bb9aec1a57eda53dc
library(ggplot2)

ggplot(RNA_flagstat, aes(x = Timepoint, y = Duplication..*100, fill = Species)) +
  geom_boxplot() +
 geom_jitter(aes(fill = Species),
              position = position_jitterdodge(jitter.width = 0.2,
                                              dodge.width = 0.8),
...
```{r Plotting_Barplot_Mapping,fig.height=8,fig.width=14}
ggplot(RNA_flagstat, aes(x = row_names, y = X..Mapped)) +
  geom_col() +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1,vjust=0.4,size=9)) +
  labs(
...
<<<<<<< HEAD
```{r Plotting_Boxplot_Mapping_bytimepoint,fig.height=8,fig.width=12}
=======
```{r Plotting_Boxplot_Mapping_bytimepoint fig.height=8,fig.width=12}
>>>>>>> da5ca35b22febe8b1241973bb9aec1a57eda53dc
library(ggplot2)

ggplot(RNA_flagstat, aes(x = Timepoint, y = X..Mapped, fill = Species)) +
  geom_boxplot() +
 geom_jitter(aes(fill = Species),
              position = position_jitterdodge(jitter.width = 0.2,
                                              dodge.width = 0.8),
...
```{r Plotting_Barplot_ProperPairing,fig.height=8,fig.width=14}
ggplot(RNA_flagstat, aes(x = row_names, y = Properly.Paired.Mapped)) +
  geom_col() +
  theme_bw() +
  scale_y_continuous(limits = c(0, 100))+
  theme(axis.text.x = element_text(angle = 90, hjust = 1,vjust=0.4,size=9)) +
...
```
<<<<<<< HEAD
```{r Plotting_Barplot_ProperPairing_bytimepoint,fig.height=8,fig.width=12}
=======
```{r Plotting_Barplot_ProperPairing_bytimepoint fig.height=8,fig.width=12}
>>>>>>> da5ca35b22febe8b1241973bb9aec1a57eda53dc
library(ggplot2)

ggplot(RNA_flagstat, aes(x = Timepoint, y = Properly.Paired.Mapped, fill = Species)) +
  geom_boxplot() +
 geom_jitter(aes(fill = Species),
              position = position_jitterdodge(jitter.width = 0.2,
                                              dodge.width = 0.8),
  ...
  theme_bw() +
  labs(
    title = "Properly Pairing Mapped Reads",
    x = "Timepoint",
    y = "Percent Properly Paired"
  )
...
```
<<<<<<< HEAD
```{r Plotting_Barplot_FinalCount_bytimepoint,fig.height=8,fig.width=12}
=======
```{r Plotting_Barplot_FinalCount_bytimepoint fig.height=8,fig.width=12}
>>>>>>> da5ca35b22febe8b1241973bb9aec1a57eda53dc
library(ggplot2)

ggplot(RNA_flagstat, aes(x = Timepoint, y = Read.Pairs, fill = Species)) +
  geom_boxplot() +
 geom_jitter(aes(fill = Species),
              position = position_jitterdodge(jitter.width = 0.2,
                                              dodge.width = 0.8),
